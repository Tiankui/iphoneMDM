...
my_test_provisioning_uuid = 'ef7756dcc50295b6f220d25f418c8d1fa539131e'
###########################################################################
last_result = ''
last_sent = ''
global mdm_commands
...
#    )
    ...
    if 'test.mobileconfig' in os.listdir('.'):
        my_test_prov_profile = open('test.mobileconfig', 'rb').read()
        print "ok"
    else:
        print "Can't find test.mobile provision in current directory."
        sys.exit()
